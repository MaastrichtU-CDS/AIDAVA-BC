# AIDAVA-BC
Supplementary materials for AIDAVA (G1) breast cancer case

This Github repository includes:
1. Sample data files for the development of personal health knowledge graphs
2. Samples files of graph outputs with RDF triples
